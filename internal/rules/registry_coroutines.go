...
func registerCoroutinesRules() {
	registerCoroutinesCollectInOnCreateWithoutLifecycle()
	registerCoroutinesGlobalCoroutineUsage()
	registerCoroutinesInjectDispatcher()
	registerCoroutinesRedundantSuspendModifier()
	registerCoroutinesSleepInsteadOfDelay()
	registerCoroutinesCoroutineLaunchedInTestWithoutRunTest()
	registerCoroutinesSuspendFunInFinallySection()
	registerCoroutinesSuspendFunSwallowedCancellation()
	registerCoroutinesSuspendFunWithCoroutineScopeReceiver()
	registerCoroutinesChannelReceiveWithoutClose()
	registerCoroutinesCollectionsSynchronizedListIteration()
	registerCoroutinesConcurrentModificationIteration()
	registerCoroutinesCoroutineScopeCreatedButNeverCancelled()
	registerCoroutinesDeferredAwaitInFinally()
	registerCoroutinesFlowWithoutFlowOn()
	registerCoroutinesSynchronizedOnString()
	registerCoroutinesSynchronizedOnBoxedPrimitive()
	registerCoroutinesSynchronizedOnNonFinal()
	registerCoroutinesVolatileMissingOnDcl()
	registerCoroutinesMutableStateInObject()
	registerCoroutinesStateFlowMutableLeak()
	registerCoroutinesSharedFlowWithoutReplay()
	registerCoroutinesStateFlowCompareByReference()
	registerCoroutinesGlobalScopeLaunchInViewModel()
	registerCoroutinesSupervisorScopeInEventHandler()
	registerCoroutinesWithContextInSuspendFunctionNoop()
	registerCoroutinesLaunchWithoutCoroutineExceptionHandler()
	registerCoroutinesMainDispatcherInLibraryCode()
}

func registerCoroutinesCollectInOnCreateWithoutLifecycle() {
...
func registerCoroutinesInjectDispatcher() {
...
func registerCoroutinesSleepInsteadOfDelay() {
...
func registerCoroutinesCoroutineLaunchedInTestWithoutRunTest() {
...
func registerCoroutinesSuspendFunInFinallySection() {
...
func registerCoroutinesSuspendFunSwallowedCancellation() {
...
func registerCoroutinesSuspendFunWithCoroutineScopeReceiver() {
...
func registerCoroutinesChannelReceiveWithoutClose() {
...
func registerCoroutinesCollectionsSynchronizedListIteration() {
...
func registerCoroutinesConcurrentModificationIteration() {
...
func registerCoroutinesCoroutineScopeCreatedButNeverCancelled() {
...
func registerCoroutinesDeferredAwaitInFinally() {
...
func registerCoroutinesFlowWithoutFlowOn() {
...
func registerCoroutinesSynchronizedOnString() {
...
func registerCoroutinesSynchronizedOnBoxedPrimitive() {
...
func registerCoroutinesSynchronizedOnNonFinal() {
...
func registerCoroutinesVolatileMissingOnDcl() {
...
func registerCoroutinesMutableStateInObject() {
...
func registerCoroutinesStateFlowMutableLeak() {
	...
	api.Register(&api.Rule{
		...
		Check: func(ctx *api.Context) {
			...
			if scanner.IsTestFile(file.Path) || file.FlatHasAncestorOfType(idx, "function_body") {
				return
			}
...
func registerCoroutinesSharedFlowWithoutReplay() {
...
func registerCoroutinesStateFlowCompareByReference() {
...
func registerCoroutinesGlobalScopeLaunchInViewModel() {
...
func registerCoroutinesSupervisorScopeInEventHandler() {
...
func registerCoroutinesLaunchWithoutCoroutineExceptionHandler() {
...
func registerCoroutinesMainDispatcherInLibraryCode() {
